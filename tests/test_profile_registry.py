...
def test_registry_selects_guitar_hero_v8_and_aliases():
    profile = build_profile({"name": "gh1", "difficulty": "easy"})
    assert type(profile) is GuitarHeroV8Profile
    assert GuitarHeroProfile is GuitarHeroV8Profile
    assert GuitarHeroV2Profile is not GuitarHeroV8Profile
    assert GuitarHeroV3Profile is not GuitarHeroV8Profile
    assert GuitarHeroV4Profile is not GuitarHeroV8Profile
    assert GuitarHeroV5Profile is not GuitarHeroV8Profile
    assert GuitarHeroV6Profile is not GuitarHeroV8Profile
    assert GuitarHeroV7Profile is not GuitarHeroV8Profile
