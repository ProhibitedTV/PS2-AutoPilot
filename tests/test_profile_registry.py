...
def test_registry_selects_guitar_hero_v5_and_aliases():
    profile = build_profile({"name": "gh1", "difficulty": "easy"})
    assert type(profile) is GuitarHeroV5Profile
    assert GuitarHeroProfile is GuitarHeroV5Profile
    assert GuitarHeroV2Profile is not GuitarHeroV5Profile
    assert GuitarHeroV3Profile is not GuitarHeroV5Profile
    assert GuitarHeroV4Profile is not GuitarHeroV5Profile
