...
def test_registry_selects_nfs_hp2_v10():
    profile = build_profile({"name": "nfs_hot_pursuit_2"})
    assert type(profile) is NfsHotPursuit2V10Profile
    assert NfsHotPursuit2Profile is NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V1Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V2Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V3Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V4Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V5Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V6Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V7Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V8Profile is not NfsHotPursuit2V10Profile
    assert NfsHotPursuit2V9Profile is not NfsHotPursuit2V10Profile
