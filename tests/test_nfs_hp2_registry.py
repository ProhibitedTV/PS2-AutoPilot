...
def test_registry_selects_nfs_hp2_v4():
    profile = build_profile({"name": "nfs_hot_pursuit_2"})
    assert type(profile) is NfsHotPursuit2V4Profile
    assert NfsHotPursuit2Profile is NfsHotPursuit2V4Profile
    assert NfsHotPursuit2V1Profile is not NfsHotPursuit2V4Profile
    assert NfsHotPursuit2V2Profile is not NfsHotPursuit2V4Profile
    assert NfsHotPursuit2V3Profile is not NfsHotPursuit2V4Profile
