...
def _madden_factory(cfg: dict) -> GameProfile:
    return Madden2005V29Profile(dict(cfg))
...
PROFILE_SPECS: dict[str, ProfileSpec] = {
    ...
    "madden2005": ProfileSpec(
        ...
        # V28 added root-menu reacquisition; V29 adds live-evidence visual play-call
        # reacquisition and a game-native Ask Madden fallback for OCR-sparse screens.
