...
class RuntimeObserver:
    ...
    def _compact_state(state: dict[str, Any]) -> dict[str, Any]:
        keys = (
            ...
            "nfs_raw_screen",
            "nfs_road_confidence",
            "nfs_road_rejection_reason",
            "nfs_road_center_x",
            "nfs_road_curvature",
            "nfs_road_width",
            "nfs_road_coverage",
            "nfs_road_center_contact",
            "nfs_race_entries",
            ...
            "nfs_blind_moving_restarts",
            "nfs_wrong_way_restarts",
            "nfs_fast_takeover_hud_blocks",
    ...
    def _check_failure_triggers(
        ...
        for key, label in (
            ...
            ("nfs_blind_moving_restarts", "nfs-moving-blind-restart"),
            ("nfs_wrong_way_restarts", "nfs-wrong-way-restart"),
        ):
